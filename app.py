...
st.markdown("""
    ...
    /* Alinhamento à esquerda para os itens pequenos */
    .left-align {
    ...
    /* Botão Esqueci a Senha - Discreto e no Canto Esquerdo */
...
if not st.session_state['logged_in']:
    ...
    with center_col:
        ...
        if st.session_state['auth_mode'] == 'login':
            ...
            # --- MUDANÇA: REMEMBER E FORGOT À ESQUERDA ---
    ...
    # --- APP LOGADO (MANTIDO EXATAMENTE COMO NO SEU CÓDIGO) ---
    with st.sidebar:
